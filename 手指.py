...
while True:
    ...
    if lmList:
        ...
        if totalFingers == 0:
            cv2.putText(img, 'Rock', (bbox[0] + 200, bbox[1] - 30),
                        cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
        elif totalFingers == 5:
            cv2.putText(img, 'Paper', (bbox[0] + 200, bbox[1] - 30),
                        cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
        elif fingers[1] == fingers[2] == 1:
            cv2.putText(
                img, 'Scissors', (bbox[0] + 200, bbox[1] - 30), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
